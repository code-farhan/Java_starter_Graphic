...
import static libs.DesktopJavaFramework.AppPropertyType.APP_FILE_FOOLPROOF_SETTINGS;
import static libs.DesktopJavaFramework.AppPropertyType.APP_TITLE;
import libs.DesktopJavaFramework.AppTemplate;
import java.io.File;
import java.io.IOException;
import static libs.DesktopJavaFramework.AppPropertyType.APP_UNDO_FOOLPROOF_SETTINGS;
...
public class AppFileModule {
    ...
    public static final String workFilePath = AppTemplate.PATH_DATA + "work" +File.separator + "new_file.ta";
    ...
    public void newWork() {
        ...
        app.getGUIModule().getWindow().setTitle(props.getProperty(AppPropertyType.APP_TITLE));
    ...
    public void closeWork() {
        ...
        // RESET THE UI CONTROLS
        app.getFoolproofModule().updateControls(AppPropertyType.APP_FILE_FOOLPROOF_SETTINGS);
        app.getFoolproofModule().updateControls(AppPropertyType.APP_UNDO_FOOLPROOF_SETTINGS);
    }
	...
	saved = true;
        ...
        // SET THE WINDOW TITLE        
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        String title = props.getProperty(AppPropertyType.APP_TITLE) + " - " + workFile.getName();
