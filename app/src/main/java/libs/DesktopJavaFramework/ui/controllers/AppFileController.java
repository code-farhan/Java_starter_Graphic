...
public class AppFileController {
    ...
    public void processNewRequest() {
        ...
        try {
            ...
            if (continueToMakeNew) {
                ...
                if (props.isTrue(AppPropertyType.HAS_NEW_DIALOG)) {
            ...
            AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), AppPropertyType.NEW_ERROR_TITLE, AppPropertyType.NEW_ERROR_CONTENT);
        }
    }
    ...
    public void processCloseRequest() {
        ...
        try {
            ...
            // SOMETHING WENT WRONG, PROVIDE FEEDBACK
            AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), AppPropertyType.SAVE_ERROR_TITLE, AppPropertyType.SAVE_ERROR_CONTENT);
        }
    }
    ...
    public void processSaveRequest() {
        ...
        try {
            ...
            if (fileSettings.wasSaved()) {
                ...
                File saveFile = AppDialogsFacade.showSaveDialog(app.getGUIModule().getWindow(), AppPropertyType.SAVE_WORK_TITLE);
                if (saveFile != null) {
    ...
    public void processExportRequest() {
        AppFileModule fileSettings = app.getFileModule();
         String workFileName = "new_file.ta";
...
//            commented out for more control
//            AppDialogsFacade.showExportDialog(app);
        } catch (IOException ioe) {
            AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), AppPropertyType.EXPORT_ERROR_TITLE, AppPropertyType.EXPORT_ERROR_CONTENT);
        }
    }
    ...
    private boolean promptToSave() throws IOException {
        ...
        ButtonType selection = AppDialogsFacade.showYesNoCancelDialog(app.getGUIModule().getWindow(), AppPropertyType.SAVE_VERIFY_TITLE, AppPropertyType.SAVE_VERIFY_CONTENT);
        ...
        if (selection == ButtonType.YES) {
            ...
            AppFileModule fileSettings = app.getFileModule();
            if (!fileSettings.wasSaved()) {
                File selectedFile = AppDialogsFacade.showSaveDialog(app.getGUIModule().getWindow(), AppPropertyType.SAVE_WORK_TITLE);
    ...
    private void promptToOpen() {
        ...
        File selectedFile = AppDialogsFacade.showOpenDialog(app.getGUIModule().getWindow(), AppPropertyType.LOAD_WORK_TITLE);
